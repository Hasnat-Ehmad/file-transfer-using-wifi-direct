package com.wifidirect.filetransfer;
...
import com.wifidirect.filetransfer.adapter.DeviceAdapter;
import com.wifidirect.filetransfer.broadcast.DirectBroadcastReceiver;
import com.wifidirect.filetransfer.callback.DirectActionListener;
import com.wifidirect.filetransfer.task.WifiClientTask;
import com.wifidirect.filetransfer.util.WifiP2pUtils;
import com.wifidirect.filetransfer.widget.LoadingDialog;
...
public class SendFileActivity extends BaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menuDirectEnable) {
            if (wifiP2pManager != null && channel != null) {
                ...
                showToast("Wifi Direct not supported by current device");
            }
            return true;
    ...
    private void navToChosePicture() {
        ...
        startActivityForResult(i, CODE_CHOOSE_FILE);
    }
