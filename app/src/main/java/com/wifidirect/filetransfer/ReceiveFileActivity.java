...
import com.wifidirect.filetransfer.model.FileTransfer;
import com.wifidirect.filetransfer.service.WifiServerService;
        ...
        public void onTransferFinished(final File file) {
            runOnUiThread(() -> {
                ...
                if (file != null && file.exists()) {
                    Log.e("filePath after recieve", file.getAbsolutePath());
