package com.wifidirect.filetransfer.broadcast;
...
public class DirectBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action != null) {
            switch (action) {
                // Used to indicate if Wifi P2P is available
                ...
                // Wifi P2P The connection status has changed
                ...
                //The device information for this device has changed
